...
MillionSend: the team's name, verified domains (plus each one's registrable
domain, the form links are shown in, where the suffix is unambiguous), days since its first send
