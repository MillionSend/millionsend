...
policy, SNS event topic, SQS events queue, SES configuration set — plus a push
subscription when your deployment has a public HTTPS URL), then download the compose file and
