...
UTC. Os envios continuam passando até 50% além do limite antes de estacionar,
para um dia movimentado não ser cortado no limite. Os owners recebem e-mail em
80% do limite, no limite e quando os envios começam a estacionar; um upgrade
de plano libera o que estava estacionado em poucos minutos.
