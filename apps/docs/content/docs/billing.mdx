...
to 50% past the cap before parking, so a busy day is not cut off at the cap.
Owners are emailed at 80% of the cap, at the cap, and when parking begins; a
plan upgrade releases parked mail within minutes.
