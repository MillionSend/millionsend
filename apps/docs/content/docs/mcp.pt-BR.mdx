...
| `get_webhook` | `webhooks:write` | Busca um webhook, incluindo o segredo de assinatura. |
...
| `create_webhook` | `webhooks:write` | Cria um webhook; a resposta inclui o segredo de assinatura. |
| `update_webhook` | `webhooks:write` | Atualiza URL, eventos ou status de um webhook. |
| `delete_webhook` | `webhooks:write` | Exclui um webhook. |
