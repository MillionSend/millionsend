...
| `--no-color` | Sem cores ANSI. `NO_COLOR` também é respeitado. |
...
| `.millionsend/migrate-report.md` | O mesmo relatório em Markdown: contagens, o checklist, os registros DNS por domínio, os itens manuais. |
