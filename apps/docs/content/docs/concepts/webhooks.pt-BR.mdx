...
própria fila, drenada em ordem a até **20 requisições por segundo**; uma
rajada de eventos espera na fila em vez de atingir o receptor de uma vez.
...
uma vez por dia — quando a fila dele tem mais de uma hora de atraso. O painel
