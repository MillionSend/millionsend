...
since Chrome's user-agent reduction, and every link of a message hit within a
second, are a machine's whatever they call themselves. A click recorded before
