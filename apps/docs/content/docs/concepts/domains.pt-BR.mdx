...
navegador envia desde a redução de user agent do Chrome, e todos os links de
uma mensagem acessados em um segundo, são de uma máquina, seja lá como ela se
