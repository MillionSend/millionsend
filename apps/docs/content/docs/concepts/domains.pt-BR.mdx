...
mantém só as regras por user agent). Links passam pelas mesmas regras: um que
um gateway de segurança ou uma pré-visualização seguiu é pré-carregamento, não
clique.
