...
/**
 * ⓘ info tooltip — a muted 14px circle-i trigger opening a portaled
 * .ms-tooltip panel centered above the anchor (flipping below near the
 * viewport top). Opens on hover and focus; click/tap toggles it pinned for
